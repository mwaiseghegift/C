...
int main(){
    ...
    // Commented be caue the code is misbehaving if I initialize A pr B
    ...
    if (reversedNumberArray[0] > reversedNumberArray[1]) {
        M = reversedNumberArray[0];
    }
     else if (reversedNumberArray[1] < reversedNumberArray[0]) {
         M = reversedNumberArray[1];
     }
     else  printf("Error");
    */
